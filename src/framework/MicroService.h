...
*/
		...
		inline Types::MicroServiceMetaVec GetServices(const std::string & Type);
		inline Types::MicroServiceMetaVec GetServices();
	...
	inline Types::MicroServiceMetaVec MicroService::GetServices(const std::string & Type) {
	    std::lock_guard G(InfraMutex_);
	...
	inline Types::MicroServiceMetaVec MicroService::GetServices() {
	    std::lock_guard G(InfraMutex_);
