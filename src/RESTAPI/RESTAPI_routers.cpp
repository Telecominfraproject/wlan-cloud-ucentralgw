...
namespace OpenWifi {
	...
	RESTAPI_ExtRouter(const std::string &Path, RESTAPIHandler::BindingMap &Bindings,
		...
		return RESTAPI_Router<
			...
			RESTAPI_capabilities_handler, RESTAPI_telemetryWebSocket>(Path, Bindings, L, S,
																	  TransactionId);
	}
	...
	RESTAPI_IntRouter(const std::string &Path, RESTAPIHandler::BindingMap &Bindings,
		...
		return RESTAPI_Router_I<
			...
			RESTAPI_script_handler, RESTAPI_blacklist_list>(Path, Bindings, L, S, TransactionId);
	}
} // namespace OpenWifi